    ...
    <main className="page">
      <header className="hero">
        ...
        <h1 className="hero-title">
          Every competition, program, and fellowship worth your time â€”
        ...
        <p className="hero-sub">
          ...
          track the ones you want, and let the fuse tell you what&apos;s closing soon.
        </p>
      </header>
      ...
      <section className="controls" aria-label="Search and filters">
        <input
          className="search"
          type="search"
          placeholder="Search opportunities, fields, organizersâ€¦"
          value={q}
        ...
        <section className="grid">
          {results.map((op) => (
            <OpportunityCard
              ...
              trhÚÙY[™›Ï^Ý˜XÚÙYÛÜšY_BˆÛ•ÙÙÛO^ÝÙÙÛU˜XÚÙYBˆÏ‚ˆ
J_BˆÜÙXÝ[Û‚ˆ
_BˆÛXZ[‚ˆ
NÂŸB